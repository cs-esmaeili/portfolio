...
const modalContent = {
  Cube001: {
    title: "My Portfolio",
    content:
      "I created an interactive 3D website using Three.js, featuring detailed models designed in Blender.This project brings products and ideas to life in an immersive, visually stunning way right in the browser.",
  ...
  Cube019: {
    title: "Chee Market",
    content:
      "I previously developed a versatile e-commerce platform that works seamlessly across all devices and platforms.It offers a smooth shopping experience, making it easy for users to browse, buy, and manage their orders anywhere.",
    link: "https://example.com/",
  },
};
...
directionalLight.position.set(-50, 110, 180);
...
function respawnCharacter() {
  ...
  // Restore original scale after respawn
  character.instance.scale.set(
    character.originalScale.x,
    character.originalScale.y,
    character.originalScale.z
  );
...
function handleJumpAnimation() {
  ...
  // Use the original scale as base for animations
  const baseScale = character.originalScale;
